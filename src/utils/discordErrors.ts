 ...
 * @param {Record<string, unknown>} errors - Discord validation errors object
 ...
 * @param {ChatInputCommandInteraction | MessageContextMenuCommandInteraction} interaction - Discord interaction
 * @param {string} message - Error message
...
export async function safeReply(
    ...
    try {
        ...
        if (error && typeof error === 'object' && 'code' in error && error.code === DiscordErrorCodes.UNKNOWN_INTERACTION) {
            return false;
        }
