...
// SHA-256 integrity verification for plugin files
...
export interface VerifyPluginManifestOptions {
    pluginsRoot?: string;
    manifestPath?: string;
    manifestData?: Record<string, string> | null;
    allowUnverified?: boolean;
}

export interface VerifyPluginManifestResult {
    ok: boolean;
    skipped?: boolean;
    checked?: number;
    errors?: string[];
