        ...
        try {
            ...
            if (thresholds.ban && warningCount >= thresholds.ban) {
                ...
                try {
                    ...
                    logger.error({ err: muteError, msg: '[ERROR] Auto-mute failed:' });
                }
            }
            ...
            logger.info({ msg: `[MODERATION] User ${user.tag} warned by ${interaction.user.tag}. Total: ${warningCount}. Reason: ${reason}` });
