...
export default class UtilityPlugin extends Plugin {
    ...
    _registerSocketHandlers() {
        ...
        this.manager.registerSocketHandler('utility.embed', async(client, args) => {
            ...
            if (parsed.title && !args.title) {embed.setTitle(parsed.title);} else if (args.title) {embed.setTitle(args.title);}

            if (parsed.description && !args.description) {embed.setDescription(parsed.description);} else if (args.description) {embed.setDescription(args.description);}
            ...
            if (args.footer) {embed.setFooter({ text: args.footer });} else if (parsed.footer) {embed.setFooter(parsed.footer);}
