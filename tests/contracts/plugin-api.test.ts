...
import Plugin, { type TypedClient as PluginClient } from '../../src/core/Plugin.js';
import type { TypedClient as ManagerClient, PluginConstructor } from '../../src/core/PluginManager.js';
import type { CommandModule } from '../../src/types/plugin.js';
...
describe('Plugin API Contract', () => {
    let mockClient: PluginClient & ManagerClient;
    ...
    beforeEach(async() => {
        ...
        }) as unknown as PluginClient & ManagerClient;
    ...
    describe('Plugin Base Class Lifecycle', () => {
        it('should call onLoad before onEnable', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-lifecycle'; }
        ...
        it('should call onLoad only once', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-load-once'; }
        ...
        it('should call onEnable only when not already enabled', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-enable-once'; }
        ...
        it('should call onDisable only when enabled', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-disable-once'; }
        ...
        it('should call onUnload only when loaded', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-unload-once'; }
        ...
        it('should maintain correct lifecycle order across multiple enable/disable cycles', async() => {
            ...
            class TestPlugin extends Plugin {
                static override get id() { return 'test-multi-cycle'; }
                
                override async onLoad() { lifecycleOrder.push('onLoad'); }
                override async onEnable() { lifecycleOrder.push('onEnable'); }
                override async onDisable() { lifecycleOrder.push('onDisable'); }
                override async onUnload() { lifecycleOrder.push('onUnload'); }
            }
    ...
    describe('Command Registration', () => {
        it('should register commands with the plugin', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-commands'; }
            }
        ...
        it('should unregister commands on unload', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-unload-commands'; }
            }
        ...
        it('should provide getCommands method for command sync', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-get-commands'; }
            ...
            const cmd1 = { name: 'cmd1', data: { toJSON: () => ({ name: 'cmd1' }) } } as unknown as CommandModule;
            const cmd2 = { name: 'cmd2', data: { toJSON: () => ({ name: 'cmd2' }) } } as unknown as CommandModule;
    ...
    describe('Event Registration', () => {
        it('should register event handlers with the client', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-events'; }
            }
        ...
        it('should unregister event handlers on unload', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-unload-events'; }
            }
        ...
        it('should support once event handlers', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-once-events'; }
            }
    ...
    describe('Plugin Dependencies', () => {
        it('should respect dependency order when enabling', async() => {
            ...
            class DepPlugin extends Plugin {
                static override get id() { return 'dependency'; }
                static override get dependencies() { return []; }
                override async onEnable() { enableOrder.push('dependency'); }
            }
            
            class MainPlugin extends Plugin {
                static override get id() { return 'main'; }
                static override get dependencies() { return ['dependency']; }
                override async onEnable() { enableOrder.push('main'); }
            }
            
            pluginManager._pluginRegistry.set('dependency', DepPlugin as unknown as PluginConstructor);
            pluginManager._pluginRegistry.set('main', MainPlugin as unknown as PluginConstructor);
        ...
        it('should throw when enabling plugin with unmet dependency', async() => {
            class MainPlugin extends Plugin {
                static override get id() { return 'main'; }
                static override get dependencies() { return ['missing-dep']; }
            }
    ...
    describe('Plugin State Management', () => {
        it('should track loaded state', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-state'; }
            }
        ...
        it('should track enabled state', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-enabled-state'; }
            }
        ...
        it('should provide version and metadata', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-metadata'; }
                static override get version() { return '2.5.0'; }
                static override get dependencies() { return ['dep1', 'dep2']; }
            }
    ...
    describe('PluginManager Integration', () => {
        ...
        it('should list plugins with correct status', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-list'; }
                static override get version() { return '1.0.0'; }
                static override get dependencies() { return []; }
            }
            
            pluginManager._pluginRegistry.set('test-list', TestPlugin as unknown as PluginConstructor);
        ...
        it('should check if plugin is enabled', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-is-enabled'; }
                static override get dependencies() { return []; }
            }
            
            pluginManager._pluginRegistry.set('test-is-enabled', TestPlugin as unknown as PluginConstructor);
    ...
    describe('Error Handling in Lifecycle', () => {
        it('should propagate errors from onLoad', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-load-error'; }
        ...
        it('should propagate errors from onEnable', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-enable-error'; }
        ...
        it('should propagate errors from onDisable', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-disable-error'; }
        ...
        it('should propagate errors from onUnload', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-unload-error'; }
    ...
    describe('Scheduler Management', () => {
        it('should track schedulers and stop them on unload', async() => {
            class TestPlugin extends Plugin {
                static override get id() { return 'test-schedulers'; }
            }
