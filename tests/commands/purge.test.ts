...
describe('Purge Command', () => {
    ...
    describe('Command Metadata', () => {
        ...
        it('should have correct option constraints', () => {
            const amountOption = purgeCommand.options.find((o: { name: string }) => o.name === 'amount');
    ...
    describe('execute - Success Cases', () => {
        it('should delete messages successfully', async() => {
            await purgeCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
        ...
        it('should include channel info in response', async() => {
            ...
            const replyCall = mockInteraction.reply.mock.calls[0]![0];
            const channelField = replyCall.embeds[0].fields.find((f: { name: string; value: string }) => f.name.includes('Channel'));
    ...
    describe('execute - Filter by User', () => {
        ...
        it('should show filtered user in response', async() => {
            ...
            const replyCall = mockInteraction.reply.mock.calls[0]![0];
            const filterField = replyCall.embeds[0].fields.find((f: { name: string; value: string }) => f.name.includes('Filtered'));
