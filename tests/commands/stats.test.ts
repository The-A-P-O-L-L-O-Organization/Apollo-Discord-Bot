...
describe('Stats Command', () => {
    ...
    describe('execute - Success Cases', () => {
        it('should display stats embed', async() => {
            await statsCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
        ...
        it('should show uptime', async() => {
            ...
            const systemField = embed.fields.find((f: { name: string; value: string }) => f.name === 'System');
        ...
        it('should show session stats', async() => {
            ...
            const sessionField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Session Stats');
        ...
        it('should show latency', async() => {
            ...
            const latencyField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Latency');
