...
import type { ChatInputCommandInteraction, Guild, Message, TextChannel } from 'discord.js';
...
import type { MockCommandInteraction, MockGuild, MockMessage, MockRole, MockTextChannel } from '../mocks/discord.js';
...
describe('ReactionRole Command', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(getGuildData).mockResolvedValue({ roles: [] });
    });
