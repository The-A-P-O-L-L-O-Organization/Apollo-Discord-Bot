...
describe('Strike Command', () => {
    ...
    describe('Command Metadata', () => {
        ...
        it('should have required user and reason options', () => {
            const userOption = strikeCommand.options.find((o: { name: string }) => o.name === 'user');
            const reasonOption = strikeCommand.options.find((o: { name: string }) => o.name === 'reason');
    ...
    describe('execute - Success Cases', () => {
        it('should strike user successfully', async() => {
            await strikeCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
