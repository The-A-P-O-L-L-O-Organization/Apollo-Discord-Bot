...
describe('Unmute Command', () => {
    ...
    let muteRole: { id: string; name: string };
    ...
    describe('Command Metadata', () => {
        ...
        it('should have correct options', () => {
            ...
            const userOption = unmuteCommand.options.find((o: { name: string }) => o.name === 'user');
            expect(userOption!.required).toBe(true);
            
            const reasonOption = unmuteCommand.options.find((o: { name: string }) => o.name === 'reason');
    ...
    describe('execute - Error Cases', () => {
        ...
        it('should reject self-unmute', async() => {
            ...
            vi.mocked(fetchMember).mockResolvedValue(createMockMember({ 
                user: sameUser, 
                moderatable: true,
                isCommunicationDisabled: vi.fn().mockReturnValue(true)
            }));
