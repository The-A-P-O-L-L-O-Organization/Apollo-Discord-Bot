...
import type { MockCommandInteraction, MockTextChannel } from '../mocks/discord.js';
...
describe('Embed Command', () => {
    ...
    beforeEach(() => {
        ...
        mockChannel = createMockChannel({ 
            ...
            name: 'test-channel'
                ...
                vi.mocked(getAutomodConfig).mockResolvedValue(mockData1 as unknown as Awaited<ReturnType<typeof getAutomodConfig>>);
    ...
    describe('execute - Banned Word Filtering', () => {
        beforeEach(() => {
            ...
            vi.mocked(checkBannedWords).mockImplementation((content, bannedWords) => {
                ...
                return null;
                        ...
                        vi.mocked(getAutomodConfig).mockResolvedValue(mockData2 as unknown as Awaited<ReturnType<typeof getAutomodConfig>>);
        });
        ...
        it('should skip banned word check when automod is disabled', async() => {
            ...
            mockInteraction.options.getString.mockImplementation(name => {
                ...
                return null;
                        ...
                        vi.mocked(getAutomodConfig).mockResolvedValue(mockData3 as unknown as Awaited<ReturnType<typeof getAutomodConfig>>);
        ...
        it('should skip banned word check when bannedWords is empty', async() => {
            const mockData4 = {
                ...
                bannedWords: []
                        ...
                        vi.mocked(checkBannedWords).mockReturnValue(null);
                        vi.mocked(getAutomodConfig).mockResolvedValue(mockData4 as unknown as Awaited<ReturnType<typeof getAutomodConfig>>);
            mockInteraction.options.getString.mockImplementation(name => {
                if (name === 'title') {return 'My Embed Title';}
                return null;
            });
