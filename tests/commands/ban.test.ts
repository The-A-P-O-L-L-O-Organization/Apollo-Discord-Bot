...
describe('Ban Command', () => {
    ...
    describe('Command Metadata', () => {
        ...
        it('should have correct options', () => {
            ...
            const userOption = banCommand.options.find((o: { name: string }) => o.name === 'user');
            expect(userOption!.required).toBe(true);
            
            const reasonOption = banCommand.options.find((o: { name: string }) => o.name === 'reason');
            expect(reasonOption!.required).toBe(false);
            
            const deleteDaysOption = banCommand.options.find((o: { name: string }) => o.name === 'delete-days');
    ...
    describe('execute - Success Cases', () => {
        it('should ban user successfully', async() => {
            await banCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
