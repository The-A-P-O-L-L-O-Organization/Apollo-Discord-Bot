...
import type { MockCommandInteraction, MockGuild, MockGuildMember } from '../mocks/discord.js';
import { ChannelType } from 'discord.js';

describe('ServerInfo Command', () => {
    let mockInteraction: MockCommandInteraction;
    let mockGuild: MockGuild;
    let mockOwner: MockGuildMember;
    ...
    describe('execute - Success Cases', () => {
        it('should display server information', async() => {
            await serverInfoCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
        ...
        it('should show member counts', async() => {
            ...
            const membersField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Members'));
        ...
        it('should show channel counts', async() => {
            ...
            const channelsField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Channels'));
        ...
        it('should show boost status', async() => {
            ...
            const boostField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Boost'));
        ...
        it('should show security settings', async() => {
            ...
            const securityField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Security'));
        ...
        it('should show owner information', async() => {
            ...
            const generalField = embed.fields.find((f: { name: string; value: string }) => f.name === 'General');
        ...
        it('should show role and emoji counts', async() => {
            ...
            const otherField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Other');
