...
describe('Unban Command', () => {
    ...
    describe('Command Metadata', () => {
        ...
        it('should have correct options', () => {
            ...
            const userIdOption = unbanCommand.options.find((o: { name: string }) => o.name === 'user-id');
            expect(userIdOption!.required).toBe(true);
            
            const reasonOption = unbanCommand.options.find((o: { name: string }) => o.name === 'reason');
    ...
    describe('execute - Success Cases', () => {
        it('should unban user successfully', async() => {
            await unbanCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
