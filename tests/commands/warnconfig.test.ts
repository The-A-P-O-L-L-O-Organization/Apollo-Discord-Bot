...
import type { MockCommandInteraction, MockGuild } from '../mocks/discord.js';
...
describe('WarnConfig Command', () => {
    ...
    describe('Command Metadata', () => {
        ...
        it('should have view, set, setmuteduration, and reset subcommands', () => {
            const subcommands = warnconfigCommand.options.map((o: { name: string }) => o.name);
    ...
    describe('execute - View Subcommand', () => {
        ...
        it('should display current configuration', async() => {
            ...
            await warnconfigCommand.execute(mockInteraction as unknown as ChatInputCommandInteraction);
        ...
        it('should show default config when none is set', async() => {
            ...
            const muteField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Mute'));
        ...
        it('should display disabled thresholds as Disabled', async() => {
            ...
            const muteField = embed.fields.find((f: { name: string; value: string }) => f.name.includes('Mute Threshold'));
    ...
    describe('execute - Reset Subcommand', () => {
        ...
        it('should display default threshold values in response', async() => {
            ...
            const muteField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Auto-Mute');
            const kickField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Auto-Kick');
            const banField = embed.fields.find((f: { name: string; value: string }) => f.name === 'Auto-Ban');
    ...
    describe('execute - Error Handling', () => {
        it('should handle errors gracefully', async() => {
            mockInteraction.options.getSubcommand.mockReturnValue('view');
            vi.mocked(getGuildData).mockImplementation(() => {
        ...
        it('should include error message in response', async() => {
            ...
            const replyCall = mockInteraction.reply.mock.calls[0]![0];
            const errorField = replyCall.embeds[0].fields.find((f: { name: string; value: string }) => f.name === 'Error');
