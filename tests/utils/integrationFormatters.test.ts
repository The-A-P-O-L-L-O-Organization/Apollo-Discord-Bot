...
describe('integrationFormatters', () => {
    ...
    describe('formatYoutubeNotification', () => {
        it('returns a message object for a new YouTube video', async() => {
            ...
            const result = formatYoutubeNotification('Channel Name', { title: 'My Video', videoId: 'abc123', thumbnail: 'thumb.jpg' } as unknown as Parameters<typeof formatYoutubeNotification>[1]);
    ...
    describe('formatRssNotification', () => {
        it('returns a message object for an RSS item', async() => {
            ...
            const result = formatRssNotification('My Feed', { title: 'Article 1', link: 'https://example.com/1' } as unknown as Parameters<typeof formatRssNotification>[1]);
