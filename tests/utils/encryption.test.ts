...
describe('Encryption', () => {
    ...
    it('should encrypt and decrypt object fields selectively', async() => {
        ...
        const encrypted = await encryptFields(obj, ['secret', 'api_key']) as typeof obj;
    ...
    it('should decrypt object fields selectively', async() => {
        ...
        const encrypted = await encryptFields(obj, ['secret', 'api_key']) as typeof obj;
        const decrypted = await decryptFields(encrypted, ['secret', 'api_key']) as typeof obj;
    ...
    it('should handle decryption errors gracefully in decryptFields', async() => {
        ...
        const result = await decryptFields(obj, ['field']) as { field: string };
