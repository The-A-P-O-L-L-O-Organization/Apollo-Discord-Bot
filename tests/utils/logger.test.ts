...
import type { MockUserOptions, MockMemberOptions } from '../mocks/discord.js';
import {
...
describe('Logger Utility', () => {
    ...
    describe('createMessageEditEmbed', () => {
        it('should show old and new content', () => {
            ...
            const afterField = data.fields!.find((f: { name: string }) => f.name === 'After');
    ...
    describe('createMemberLeaveEmbed', () => {
        ...
        it('should show roles', () => {
            ...
            (member as unknown as { roles: unknown }).roles = {
                cache: rolesCache
            };
    ...
    describe('createVoiceChangeEmbed', () => {
        ...
        it('should create embed for moving voice channels', () => {
            ...
            const fromField = data.fields!.find((f: { name: string }) => f.name === 'From');
            const toField = data.fields!.find((f: { name: string }) => f.name === 'To');
