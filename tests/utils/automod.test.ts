...
import type { MockMessage } from '../mocks/discord.js';
...
describe('Automod Utility', () => {
    ...
    describe('checkMentionSpam', () => {
        it('should return false when mentions are below threshold', () => {
            ...
            message.mentions = {
                ...
                roles: { size: 0 },
                everyone: false
            } as unknown as MockMessage['mentions'];

            const result = checkMentionSpam(message as unknown as Message, 5);
            expect(result).toBe(false);
        });
    ...
    describe('isChannelExempt', () => {
        it('should return true for exempt channels', () => {
            ...
            const result = isChannelExempt('456', cfg as unknown as Parameters<typeof isChannelExempt>[1]);
            expect(result).toBe(true);
        });
        ...
        it('should return false for non-exempt channels', () => {
            ...
            const result = isChannelExempt('999', cfg as unknown as Parameters<typeof isChannelExempt>[1]);
            expect(result).toBe(false);
        });
        ...
        it('should return false for empty exempt list', () => {
            ...
            const result = isChannelExempt('123', cfg as unknown as Parameters<typeof isChannelExempt>[1]);
            expect(result).toBe(false);
        });
    });
});
