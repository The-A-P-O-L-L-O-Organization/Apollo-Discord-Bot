...
describe('TranslationService', () => {
    ...
    describe('constructor', () => {
        it('should use provided baseUrl', () => {
            ...
            expect((svc as unknown as { baseUrl: string }).baseUrl).toBe('https://custom.url');
        });
        ...
        it('should default baseUrl from env when not provided', () => {
            ...
            expect((svc as unknown as { baseUrl: string }).baseUrl).toBe('https://env.url');
    ...
    describe('validateLanguage', () => {
        ...
        it('should reject empty input', () => {
            ...
            expect(service.validateLanguage(null as unknown as string)).toBe(false);
            expect(service.validateLanguage(undefined as unknown as string)).toBe(false);
        });
    });
